...
| **start\_degrees** | 0 is the right side, 90 is the bottom, 180 is the left, 270 is the top. |
...
| **max\_width** | Text will be clipped if it exceeds this width in pixels. Use 0 for no limit. |
